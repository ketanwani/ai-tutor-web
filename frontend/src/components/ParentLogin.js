...
const ParentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authAPI.parentLogin(email, password);
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in to your account to manage your children's learning
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            ...
            <button
              type="button"
              onClick={() => navigate('/')}
              className="text-gray-600 hover:text-gray-500 text-sm mt-2"
            >
              ← Back to Home
            </button>
          </div>
